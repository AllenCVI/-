...
public class TextParser {
	...
	public static SpannableString changeText(String text){

		String a[] = text.split("\\.");
		int firstLength = a[0].length();
		int secondLength = a[1].length();
		SpannableString spannableString = new SpannableString(text);
		RelativeSizeSpan sizeSpanBig = new RelativeSizeSpan(0.8f);
		RelativeSizeSpan sizeSpanSmall = new RelativeSizeSpan(1.2f);
